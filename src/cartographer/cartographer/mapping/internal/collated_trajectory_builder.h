...
// 使用sensor::CollatorInterface对传感器数据进行整理，然后将其传递给mapping::TrajectoryBuilderInterface，这在2D和3D中很常见。
class CollatedTrajectoryBuilder : public TrajectoryBuilderInterface {
 public:
  ...
  CollatedTrajectoryBuilder(
      ...
      std::unique_ptr<TrajectoryBuilderInterface> wrapped_trajectory_builder); // GlobalTrajectoryBuilder指针
