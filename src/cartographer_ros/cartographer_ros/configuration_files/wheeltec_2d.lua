...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 2e2 -- Ceres 扫描匹配器的平移权重为 2e2
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.max_num_iterations = 20 -- Ceres 求解器的最大迭代次数为 20
