...
def generate_launch_description():
    ...
    ## ***** 节点 *****
    # 启动其他launch文件：cartographer_ros包的共享目录路径/launch/backpack_2d.launch.py
    ...
    rviz_node = Node(
        ...
        arguments = ['-d', FindPackageShare('cartographer_ros').find('cartographer_ros') + '/configuration_files/demo_2d.rviz'], # '-d'用于指定RViz2的配置文件，使用cartographer_ros为RViz2 2d demo写好的配置文件
