...
def generate_launch_description():
    ...
    configuration_basename = LaunchConfiguration('configuration_basename', default='wheeltec_2d.lua') # Cartographer设置文件名：wheeltec_2d.lua
    ...
    map_yaml = LaunchConfiguration('map_yaml', default='/home/zqyhia/maps/final/v05_5.yaml') # 已构建地图的yaml文件路径
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            ('/imu', '/imu/data'), # 需要订阅/imu话题，将/imu/data内容传递给/imu
            ],
            output='screen'
            ),
