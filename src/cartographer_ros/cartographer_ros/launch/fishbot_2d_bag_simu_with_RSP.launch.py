...
def generate_launch_description():
    ...
    fishbot_2d_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(FindPackageShare('cartographer_ros').find('cartographer_ros') + '/launch/fishbot_2d_with_RSP.launch.py'),
    ...
    rviz_node = Node(
        ...
        arguments = ['-d', FindPackageShare('cartographer_ros').find('cartographer_ros') + '/configuration_files/fishbot.rviz'], # '-d'用于指定RViz2的配置文件，使用cartographer_ros为RViz2 2d demo写好的配置文件
